...
export default function Privacidade() {
  return (
    <div className="Privacidade">
      ...
      <p>
        A sua privacidade é importante para nós. É política do ACADEMIA
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site ACADEMIA.
      </p>{' '}
      <p>
      ...
      <h2>Política de Cookies ACADEMIA</h2> <h3>O que são cookies?</h3>{' '}
      <p>
      ...
      <p>
        ...
        informação que o ACADEMIA oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>{' '}
      <ul>
        {' '}
        ...
        <li>
          ...
          ou casas de apostas legais, jogos de sorte e azar, qualquer tipo de
        ...
        <li>
          ...
          (softwares) do ACADEMIA, de seus fornecedores ou terceiros, para
      ...
      <h3>Regra definidas</h3>
      <p>
        Ao ler e concordar com as políticas de privacidade seguintes dados serão
        coletados ao efetivar o cadastro de usuário:
      </p>
      <ul>
        <li>Nome completo</li>
        <li>E-mail</li>
      ...
      <p>Os dados pessoais recolhidos serão usados para:</p>
      <ul>
        <li>Confirmação do cadastro no sistema</li>
        <li>Autenticação no sistema </li>
        <li>Identificação do Cliente ao utilizar dos serviços</li>
        <li>Realizar seu atendimento na academia</li>
        <li>Contato por e-mail ou telefone</li>
      </ul>
      <p>
        Aceitação da Política de Privacidade ao cadastrar: <br />
        Habilita o usuário a efetuar o seu cadastro no sistema com êxito. Logo,
        serão armazenadas parte dos seus dados pessoais concedidos no cadastro.
      </p>
      <p>
        Rejeição da Política de Privacidade ao cadastrar:
        <br />
        Desabilita o usuário a efetuar o seu cadastro no sistema. Desta forma,
        mesmo ao conceder os dados nos campos de preenchimento, nenhuma
        informação será armazenada.
      </p>
      <p>
        Alteração da Política de Privacidade: <br />
        Em caso de alteração de nossa Política de Privacidade, sujeita de
        ocorrer a qualquer momento. Os usuários vinculados ao sistema receberão
        notificação pelos seus meios de contato. A alteração entrará em vigor
        logo após a nova versão do sistema ser instaurada.
      </p>
      <p>Formato de divulgação:</p>
      <ul>
        <li>
          E-mail: Informará por completo a alteração da Política de Privacidade
          e referenciará a um link que redirecione o usuário para uma página com
          o documento completo juntamente das opções de concordância ou
          discordância do novo termo.{' '}
        </li>
        <li>
          SMS: Sucintamente, apenas informará detalhes importantes da alteração
          da Política de Privacidade. Indicará a consulta da caixa de entrada do
          e-mail para mais informação, como também referenciará a um link que
          redirecione o usuário para uma página com o documento completo
          juntamente das opções de concordância ou discordância do novo termo.{' '}
        </li>
      </ul>
      <p>
        Aceitação da Alteração da Política de Privacidade:
        <br />
        Ao aceitar, o usuário continuará a ter acesso ao sistema. Logo, os dados
        pessoais fornecidos pelo usuário também continuarão armazenados no
        sistema.
      </p>
      <p>
        Rejeição da Alteração da Política de Privacidade:
        <br />
        Ao rejeitar, o usuário não será capaz de acessar ao sistema. Desta
        forma, sua conta de usuário será desabilitada/excluída. Em caso de
        desabilitação da conta, os dados pessoais e outros registros antigos
        terão suas informações anonimizadas *(o usuário poderá habilitá-la
        novamente ao concordar com a nova alteração feita na política de
        privacidade). Em caso de exclusão da conta, os dados pessoais do usuário
        serão excluídos do sistema, e os registros antigos anonimizados.
      </p>
      ...
      <div>
        <p>
          {' '}
          Dados pessoais informados pelo cliente: nome, e-mail, telefone e
          endereço.
          <br /> Finalidades: Prestação dos serviços; Identificação e
          autenticação; Contato por telefone, e-mail, SMS, WhatsApp, ou outros
